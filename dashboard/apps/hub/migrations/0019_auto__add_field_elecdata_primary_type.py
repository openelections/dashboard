...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ElecData.primary_type'
        db.add_column('hub_elecdata', 'primary_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, db_index=True, blank=True),
                      keep_default=False)

        orm['hub.ElecData'].objects.filter(primary_party='TK').update(primary_type='closed')


    def backwards(self, orm):
        # Deleting field 'ElecData.primary_type'
        db.delete_column('hub_elecdata', 'primary_type')

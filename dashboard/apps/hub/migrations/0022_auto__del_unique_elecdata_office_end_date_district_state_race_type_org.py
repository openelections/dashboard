...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Election', fields ['office', 'end_date', 'district', 'state', 'race_type', 'organization', 'primary_party', 'special']
        db.delete_unique('hub_election', ['office_id', 'end_date', 'district', 'state_id', 'race_type', 'organization_id', 'primary_party_id', 'special'])

        # Removing unique constraint on 'ElecData', fields ['office', 'end_date', 'district', 'state', 'race_type', 'organization', 'primary_party', 'special']
        db.delete_unique('hub_elecdata', ['office_id', 'end_date', 'district', 'state_id', 'race_type', 'organization_id', 'primary_party_id', 'special'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'ElecData', fields ['office', 'end_date', 'district', 'state', 'race_type', 'organization', 'primary_party', 'special']
        db.create_unique('hub_elecdata', ['office_id', 'end_date', 'district', 'state_id', 'race_type', 'organization_id', 'primary_party_id', 'special'])

        # Adding unique constraint on 'Election', fields ['office', 'end_date', 'district', 'state', 'race_type', 'organization', 'primary_party', 'special']
        db.create_unique('hub_election', ['office_id', 'end_date', 'district', 'state_id', 'race_type', 'organization_id', 'primary_party_id', 'special'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Volunteer.attended_sprint'
        db.add_column('hub_volunteer', 'attended_sprint',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Volunteer.last_emailed'
        db.add_column('hub_volunteer', 'last_emailed',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Volunteer.attended_sprint'
        db.delete_column('hub_volunteer', 'attended_sprint')

        # Deleting field 'Volunteer.last_emailed'
        db.delete_column('hub_volunteer', 'last_emailed')

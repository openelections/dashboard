...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hub_election', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('race_type', self.gf('django.db.models.fields.CharField')(max_length=10, db_index=True)),
            ('primary_type', self.gf('django.db.models.fields.CharField')(default='', max_length=10, db_index=True, blank=True)),
            ...
            ('end_date', self.gf('django.db.models.fields.DateField')(db_index=True, blank=True)),
            ...
            ('district', self.gf('django.db.models.fields.CharField')(default='', max_length=5, db_index=True, blank=True)),
        ...
        db.send_create_signal('hub', ['Election'])

        # Adding M2M table for field formats on 'Election'
        db.create_table('hub_election_formats', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('election', models.ForeignKey(orm['hub.election'], null=False)),
            ('dataformat', models.ForeignKey(orm['hub.dataformat'], null=False))
        ))
        db.create_unique('hub_election_formats', ['election_id', 'dataformat_id'])

        # Adding unique constraint on 'Election', fields ['organization', 'race_type', 'primary_party', 'end_date', 'special', 'office', 'state', 'district']
        db.create_unique('hub_election', ['organization_id', 'race_type', 'primary_party_id', 'end_date', 'special', 'office_id', 'state_id', 'district'])


    def backwards(self, orm):
        # Removing unique constraint on 'Election', fields ['organization', 'race_type', 'primary_party', 'end_date', 'special', 'office', 'state', 'district']
        db.delete_unique('hub_election', ['organization_id', 'race_type', 'primary_party_id', 'end_date', 'special', 'office_id', 'state_id', 'district'])

        # Deleting model 'Election'
        db.delete_table('hub_election')

        # Removing M2M table for field formats on 'Election'
        db.delete_table('hub_election_formats')

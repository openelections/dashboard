...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'State.results_description'
        db.add_column(u'hub_state', 'results_description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'State.results_description'
        db.delete_column(u'hub_state', 'results_description')

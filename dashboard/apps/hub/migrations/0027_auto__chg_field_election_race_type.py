...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Election.race_type'
        db.alter_column('hub_election', 'race_type', self.gf('django.db.models.fields.CharField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'Election.race_type'
        db.alter_column('hub_election', 'race_type', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'hub.election': {
            'Meta': {'ordering': "['state', '-end_date']", 'unique_together': "(('organization', 'race_type', 'end_date', 'special', 'office', 'state', 'district'),)", 'object_name': 'Election'},

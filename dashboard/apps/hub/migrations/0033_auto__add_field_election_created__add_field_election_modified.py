...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.created'
        db.add_column('hub_election', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Election.modified'
        db.add_column('hub_election', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.created'
        db.delete_column('hub_election', 'created')

        # Deleting field 'Election.modified'
        db.delete_column('hub_election', 'modified')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Election', fields ['organization', 'state', 'race_type', 'special', 'end_date']
        db.create_unique('hub_election', ['organization_id', 'state_id', 'race_type', 'special', 'end_date'])


    def backwards(self, orm):
        # Removing unique constraint on 'Election', fields ['organization', 'state', 'race_type', 'special', 'end_date']
        db.delete_unique('hub_election', ['organization_id', 'state_id', 'race_type', 'special', 'end_date'])

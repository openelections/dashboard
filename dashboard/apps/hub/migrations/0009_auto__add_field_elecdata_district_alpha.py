...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ElecData.district_alpha'
        db.add_column('hub_elecdata', 'district_alpha',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=5, db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ElecData.district_alpha'
        db.delete_column('hub_elecdata', 'district_alpha')

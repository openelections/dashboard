...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Election.primary_type'
        db.alter_column('hub_election', 'primary_type', self.gf('django.db.models.fields.CharField')(max_length=15))

    def backwards(self, orm):

        # Changing field 'Election.primary_type'
        db.alter_column('hub_election', 'primary_type', self.gf('django.db.models.fields.CharField')(max_length=10))

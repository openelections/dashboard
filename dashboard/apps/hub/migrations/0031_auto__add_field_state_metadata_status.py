...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'State.metadata_status'
        db.add_column('hub_state', 'metadata_status',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'State.metadata_status'
        db.delete_column('hub_state', 'metadata_status')
    ...
    models = {
        ...
        'hub.state': {
            ...
            'metadata_status': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '20', 'blank': 'True'}),

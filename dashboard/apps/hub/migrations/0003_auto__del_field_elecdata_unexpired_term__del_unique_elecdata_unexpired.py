...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ElecData', fields ['unexpired_term', 'end_date', 'office', 'state', 'race_type', 'district', 'special']
        db.delete_unique('hub_elecdata', ['unexpired_term', 'end_date', 'office_id', 'state_id', 'race_type', 'district', 'special'])

        # Deleting field 'ElecData.unexpired_term'
        db.delete_column('hub_elecdata', 'unexpired_term')

        # Adding unique constraint on 'ElecData', fields ['end_date', 'office', 'district', 'state', 'race_type', 'special']
        db.create_unique('hub_elecdata', ['end_date', 'office_id', 'district', 'state_id', 'race_type', 'special'])


    def backwards(self, orm):
        # Removing unique constraint on 'ElecData', fields ['end_date', 'office', 'district', 'state', 'race_type', 'special']
        db.delete_unique('hub_elecdata', ['end_date', 'office_id', 'district', 'state_id', 'race_type', 'special'])

        # Adding field 'ElecData.unexpired_term'
        db.add_column('hub_elecdata', 'unexpired_term',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding unique constraint on 'ElecData', fields ['unexpired_term', 'end_date', 'office', 'state', 'race_type', 'district', 'special']
        db.create_unique('hub_elecdata', ['unexpired_term', 'end_date', 'office_id', 'state_id', 'race_type', 'district', 'special'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.needs_review'
        db.add_column('hub_election', 'needs_review',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.needs_review'
        db.delete_column('hub_election', 'needs_review')

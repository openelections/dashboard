...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Migration necessary to prevent errors at admin layer for pre-existing primary records"
        # Note: Remember to use orm['appname.ModelName'] rather than "from appname.models..."
        orm['hub.ElecData'].objects.filter(race_type__icontains='primary').update(primary_party='TK')

    def backwards(self, orm):
        "Write your backwards methods here."
        orm['hub.ElecData'].objects.filter(race_type__icontains='primary').update(primary_party=None)

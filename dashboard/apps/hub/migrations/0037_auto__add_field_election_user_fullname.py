...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.user_fullname'
        db.add_column(u'hub_election', 'user_fullname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=70, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.user_fullname'
        db.delete_column(u'hub_election', 'user_fullname')

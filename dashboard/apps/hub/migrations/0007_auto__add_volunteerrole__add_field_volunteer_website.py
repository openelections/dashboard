...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hub_volunteerrole', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=30)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=25)),
        ))
        db.send_create_signal('hub', ['VolunteerRole'])

        # Adding field 'Volunteer.website'
        db.add_column('hub_volunteer', 'website',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=254, blank=True),
                      keep_default=False)

        # Adding M2M table for field roles on 'Volunteer'
        db.create_table('hub_volunteer_roles', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('volunteer', models.ForeignKey(orm['hub.volunteer'], null=False)),
            ('volunteerrole', models.ForeignKey(orm['hub.volunteerrole'], null=False))
        ))
        db.create_unique('hub_volunteer_roles', ['volunteer_id', 'volunteerrole_id'])


    def backwards(self, orm):
        # Deleting model 'VolunteerRole'
        db.delete_table('hub_volunteerrole')

        # Deleting field 'Volunteer.website'
        db.delete_column('hub_volunteer', 'website')

        # Removing M2M table for field roles on 'Volunteer'
        db.delete_table('hub_volunteer_roles')

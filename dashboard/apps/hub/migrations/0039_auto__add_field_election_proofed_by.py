...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.proofed_by'
        db.add_column(u'hub_election', 'proofed_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='proofer', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.proofed_by'
        db.delete_column(u'hub_election', 'proofed_by_id')

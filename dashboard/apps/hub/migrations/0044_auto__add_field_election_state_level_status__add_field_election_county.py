...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.state_level_status'
        db.add_column(u'hub_election', 'state_level_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length='30', db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Election.county_level_status'
        db.add_column(u'hub_election', 'county_level_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length='30', db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Election.precinct_level_status'
        db.add_column(u'hub_election', 'precinct_level_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length='30', db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Election.cong_dist_level_status'
        db.add_column(u'hub_election', 'cong_dist_level_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length='30', db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Election.state_leg_level_status'
        db.add_column(u'hub_election', 'state_leg_level_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length='30', db_index=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.state_level_status'
        db.delete_column(u'hub_election', 'state_level_status')

        # Deleting field 'Election.county_level_status'
        db.delete_column(u'hub_election', 'county_level_status')

        # Deleting field 'Election.precinct_level_status'
        db.delete_column(u'hub_election', 'precinct_level_status')

        # Deleting field 'Election.cong_dist_level_status'
        db.delete_column(u'hub_election', 'cong_dist_level_status')

        # Deleting field 'Election.state_leg_level_status'
        db.delete_column(u'hub_election', 'state_leg_level_status')
    ...
    models = {
        ...
        u'hub.election': {
            ...
            'cong_dist_level_status': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': "'30'", 'db_index': 'True', 'blank': 'True'}),
            'county_level': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'county_level_status': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': "'30'", 'db_index': 'True', 'blank': 'True'}),
            ...
            'precinct_level_status': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': "'30'", 'db_index': 'True', 'blank': 'True'}),
            ...
            'state_leg_level_status': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': "'30'", 'db_index': 'True', 'blank': 'True'}),
            'state_level': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
            'state_level_status': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': "'30'", 'db_index': 'True', 'blank': 'True'}),
        ...
        u'hub.state': {
            ...
            'note': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'pain': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '15', 'blank': 'True'}),
            'postal': ('django.db.models.fields.CharField', [], {'max_length': '2', 'primary_key': 'True'}),
            'results_description': ('django.db.models.fields.TextField', [], {'blank': 'True'})
        },
        u'hub.volunteer': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.primary_note'
        db.add_column('hub_election', 'primary_note',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.primary_note'
        db.delete_column('hub_election', 'primary_note')

...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for elec in orm.Election.objects.all().select_related('user'):
            elec.user_fullname = "%s, %s" % (elec.user.last_name, elec.user.first_name)
            elec.save()

    def backwards(self, orm):
        "Write your backwards methods here."
        orm.Election.objects.update(user_fullname='')

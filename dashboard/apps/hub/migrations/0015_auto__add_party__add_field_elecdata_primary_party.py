...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ElecData.primary_party'
        db.add_column('hub_elecdata', 'primary_party',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ElecData.primary_party'
        db.delete_column('hub_elecdata', 'primary_party_id')
